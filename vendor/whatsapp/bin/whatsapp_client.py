    ...
    def messages(self, jid: str, query: str = "", limit: int = 160, around_id: str = "") -> dict[str, Any]:
            ...
            with closing(self._connect()) as connection:
                ...
                rows = connection.execute(
                    f"""SELECT base.msg_id, base.sender_jid, base.sender_name,
                      ...
                      (COALESCE(base.direct_path, '') <> '' AND COALESCE(length(base.media_key), 0) > 0) AS media_downloadable,
        ...
        for row in rows:
            ...
            values.append({
                ...
                "media_downloadable": local_exists or (bool(row["media_downloadable"]) and row["media_unavailable_at"] is None),
